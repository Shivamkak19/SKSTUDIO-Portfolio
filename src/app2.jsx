...
function Pages() {
  ...
  return (
    <>
      <Page position={[-width * 1, 0, 0]} urls={['/panels/trip1.jpg', '/panels/trip2.jpg', '/panels/trip3.jpg']} />
      <Page position={[width * 0, 0, 0]} urls={['/panels/img1.jpg', '/panels/img2.jpg', '/panels/img3.jpg']} />
      <Page position={[width * 1, 0, 0]} urls={['/panels/img4.jpg', '/panels/img5.jpg', '/panels/img6.jpg']} />
      <Page position={[width * 2, 0, 0]} urls={['/panels/trip1.jpg', '/panels/trip2.jpg', '/panels/trip3.jpg']} />
      <Page position={[width * 3, 0, 0]} urls={['/panels/img1.jpg', '/panels/img2.jpg', '/panels/img3.jpg']} />
      <Page position={[width * 4, 0, 0]} urls={['/panels/img4.jpg', '/panels/img5.jpg', '/panels/img6.jpg']} />
    </>
  )
}
